      ...
      <div className="bg-white rounded-xl w-full max-w-lg p-6 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input type="text" placeholder="Enter company name" className="w-full rounded-lg border border-bellflower-gray px-4 py-3 text-sm" />
          </div>
        ...
        <div className="flex justify-end gap-2 mt-6">
          ...
          <button className="bg-river-green text-white px-4 py-2 rounded-lg text-sm font-semibold max-w-40">Save Supplier</button>
        </div>
      </div>
    </div>
  );
